...
namespace MarioGame.Gameplay.Camera
{
    ...
    public partial class CameraController : CoreBehaviour
    {
        ...
        protected override void CacheComponents()
        {
            ...
            AssertIsNotNull(_camera, "Camera required");
        }
        ...
        {
            if (!_useDeadzone || !IsFollowingTarget)
            {
                return;
            }
